...
import { ImageIcon, Check, ArrowLeft } from 'lucide-react';
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="space-y-4">
              ...
              <div className="w-full rounded-xl overflow-hidden border border-border bg-muted shadow-sm relative aspect-video group flex items-center justify-center">
                <div className="flex flex-col items-center text-muted-foreground/40">
                  ...
                  <span className="mt-2 text-lg font-bold">Course Cover Image</span>
                </div>
              </div>
              
              <div>
                <h1 className="text-2xl md:text-4xl font-bold tracking-tight text-primary">{course.title}</h1>
            ...
            <div className="rounded-lg border border-border bg-card text-card-foreground shadow-sm">
              <div className="flex flex-col space-y-1.5 p-6 border-b border-border/50">
                <h3 className="font-semibold tracking-tight text-xl text-primary">Course Description</h3>
              </div>
              <div className="p-6 text-sm md:text-base space-y-4 text-muted-foreground leading-relaxed">
                ...
                <blockquote className="border-l-4 border-destructive pl-4 my-4 italic text-foreground bg-destructive/5 p-4 rounded-r">
                  <p>✅ <strong>বিশেষ অফার:</strong> কোর্স ফি মাত্র <strong className="text-primary">৳{course.price}</strong> (মূল ফি ৳{course.oldPrice} থেকে <strong className="text-destructive">ছাড়!</strong>)</p>
                </blockquote>
                
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                  {['লাইভ ক্লাস ও রেকর্ড সেশন', 'পিডিএফ লেকচার নোট', 'অধ্যায়ভিত্তিক ও পূর্ণাঙ্গ মডেল টেস্ট', '২৪/৭ সলভ গ্রুপ সাপোর্ট'].map((item) => (
                    <div key={item} className="flex items-center gap-3 p-3 rounded-lg border border-border bg-secondary/20">
              ...
              <div className="rounded-lg border border-primary/20 bg-card text-card-foreground shadow-lg shadow-primary/5 overflow-hidden">
                ...
                <div className="p-6 space-y-6">
                  <div className="text-center">
                    <p className="text-sm text-destructive line-through font-medium">৳{course.oldPrice}</p>
