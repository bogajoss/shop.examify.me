...
export default function CreateBatch() {
  ...
  >([
    {
      label: "To Do List Submission",
      value: "প্রতিদিন সকালে নির্দিষ্ট সময়ে To do List গ্রহন",
    },
    ...
    { label: "Quiz", value: "অতিরিক্ত প্রাকটিসের জন্য Telegram Quiz" },
    {
      ...
      value: "প্রতিদিনের To Do List, HW, Exam এর উপর Progress Report",
    },
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Fill in the details to launch a new course batch.
          </p>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input
                  id="name"
                  {...register("name")}
                  placeholder="e.g. HSC 2026 Biology Cycle"
                />
                {errors.name && (
