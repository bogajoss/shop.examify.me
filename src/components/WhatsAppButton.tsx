...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-4 sm:right-8 z-40 h-14 w-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform cursor-pointer active:scale-95 group"
    >
      <img
